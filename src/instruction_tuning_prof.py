...
# ========================================
TASK_PREFIXES = {
    'code_summary': 'summarize code:',      # Code -> Natural language description
    'bug_detection': 'is it buggy:',        # Code -> True/False
    'code_repair': 'fix a bug:',            # Buggy code -> Fixed code
    'code_generation': 'generate code:',    # Description -> Code
    'combined_repair': 'fix a bug if it is buggy:'  # Code -> Analysis + fix if needed
}
...
DATA_PATH = "data/nl_pl_dataset.json"          # Path to your training dataset
TEST_DATA_PATH = "data/nl_pl_multi_test.json"  # Path to your test dataset
...
VALIDATION_SIZE = 100         # Number of samples to use for validation
    ...
    def _create_examples(self, data):
        ...
        for item in data:
            ...
            if is_buggy and fixed_code:
                ...
                combined_output = f"Yes, the code is buggy. Fixed code:\n{fixed_code}"
                examples.append({
